...
public class PIDFControllerEx {
    ...
    public PIDFControllerEx(PIDFCoefficients coeffs) {
        this(
                coeffs.getKp(),
                coeffs.getKi(),
                coeffs.getKd(),
                ...
                coeffs.getAlpha(),
                coeffs.getDeadzone(),
                coeffs.getIntegralWorkingBounds(),
                coeffs.getIntegralClippingBounds()
        );
    }

    public PIDFControllerEx(PIDFCoefficients coeffs, double sp, double pv) {
        this(
                coeffs.getKp(),
                coeffs.getKi(),
                coeffs.getKd(),
    ...
    public void setCoefficients(PIDFCoefficients coeffs) {
        setPIDF(coeffs.getKp(), coeffs.getKi(), coeffs.getKd(), coeffs.getKf());
        setAlpha(coeffs.getAlpha());
        setIntegrationBounds(-coeffs.getIntegralClippingBounds(), coeffs.getIntegralClippingBounds());
        setWorkingBounds(coeffs.getIntegralWorkingBounds());
        setDeadzone(coeffs.getDeadzone());
    }
